...
class NauticalCatchChallengeApp:
    ...
    def chase_fish(self, diver_name: str, fish_name: str, is_lucky: bool):
        ...
        # get the existing diver in the list
        try:
            diver = [d for d in self.divers if d.name == diver_name][0]
        except IndexError:
            return f"{diver_name} is not registered for the competition."

        # get the existing fish in the list
        try:
            fish = [f for f in self.fish_list if f.name == fish_name][0]
        except IndexError:
        ...
        # check for health status after chase
    ...
    def health_recovery(self):
        divers_with_health_issues = [d for d in self.divers if d.has_health_issues]
    ...
    def competition_statistics(self):
        ...
        healthy_divers = [d for d in sorted_divers if not d.has_health_issues]
